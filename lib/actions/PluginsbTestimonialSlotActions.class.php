...
/**
 * Description of PluginsbTestimonialSlotActions
 *
 * @author Giles Smith <tech@superrb.com>
 */
abstract class PluginsbTestimonialSlotActions extends aSlotActions
{
	public function executeEdit(sfRequest $request)
  {
    ...
    $this->form = new sbTestimonialSlotEditForm($this->id, array());
